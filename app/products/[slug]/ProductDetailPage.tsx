                ...
                <div className="flex flex-col">
                    ...
                    <div className="mt-4 mb-4 flex justify-end">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="w-[52px] h-[52px] bg-[#25D366] hover:bg-[#20bd5a] transition-colors rounded-full flex items-center justify-center shadow-[0_4px_12px_rgba(37,211,102,0.4)] cursor-pointer"
                            aria-label="Chat on WhatsApp"
                        >
                            <svg className="w-8 h-8 text-white ml-[3px] mt-[3px]" fill="currentColor" viewBox="0 0 24 24">
